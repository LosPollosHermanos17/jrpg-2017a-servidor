	...
	public void resolver(EscuchaCliente cliente) {
		...
		for (EscuchaCliente clienteConectado : Servidor.getClientesConectados()) {
			try {
				...
				// Si es el personaje solicitado, se le mostrara la opcion para realizar el intercambio.
				// Si es alguno de los otros personajes, se bloquearan los personajes solicitante/solicitado en la lista.
